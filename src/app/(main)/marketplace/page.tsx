  ...
  return (
    <div className="space-y-4">
      ...
      <header className="animate-fade-in-up">
        <h1 className="font-serif text-[22px] font-light text-ink">Marketplace</h1>
        <p className="text-[12px] text-ink-muted mt-0.5">Curated with intention</p>
      </header>
      ...
      {/* Available teas — hero cards */}
      <section className="space-y-3 animate-fade-in-up animation-delay-200">
        <h2 className="text-[11px] font-medium text-ink-muted uppercase tracking-wider px-1">Available</h2>
        {[
          {
            name: "Da Hong Pao",
            type: "Oolong",
            ...
            <div className="flex items-start justify-between">
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] px-1.5 py-[1px] rounded-full bg-jade/8 text-jade-dark font-medium">Théorea</span>
                </div>
      ...
      <section className="rounded-2xl bg-porcelain shadow-[0_1px_3px_rgba(0,0,0,0.04)] animate-fade-in-up animation-delay-300">
        <div className="px-4 pt-4 pb-2">
          <h2 className="text-[11px] font-medium text-ink-muted uppercase tracking-wider">Coming soon</h2>
        </div>
        <div className="divide-y divide-black/[0.04]">
          {[
            { name: "Gyokuro Asahi", type: "Green Tea", origin: "Uji, Kyoto" },
            { name: "Aged Sheng Pu-erh", type: "Pu-erh", origin: "Yunnan" },
            { name: "Ali Shan High Mountain", type: "Oolong", origin: "Chiayi, Taiwan" },
            { name: "Silver Needle", type: "White Tea", origin: "Fuding, Fujian" },
          ].map((tea, i) => (
            <div key={i} className="flex items-center justify-between px-4 py-3">
              ...
              <span className="text-[11px] text-ink-muted/50 shrink-0 ml-3">Notify me</span>
            </div>
          ))}
        </div>
      </section>
